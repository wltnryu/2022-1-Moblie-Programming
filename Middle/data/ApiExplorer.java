...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("startCreateDt","UTF-8") + "=" + URLEncoder.encode("20220201", "UTF-8")); 
        /*검색할 생성일 범위의 시작 - 2022년 02월 01일부터 2022년 02월 23일지는 격리 해제 수가 있었던 관계로 분리해서 파싱하였지만 가독성 관계로 기간 지정*/
